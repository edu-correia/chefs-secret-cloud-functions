...
export const getExtractRecipeFromVideoUseCase = () => {
    ...
    const aiTextAnalizer = new GeminiAITextAnalizer();
    const externalFileDownloader = new FfmpegExternalFileDownloader();
    const videoInfoExtractor = new RapidApiInstagramVideoInfoExtractor();
    const aiAudioAnalyzer = new AssemblyAIAudioAnalizer();
